...
import com.woshen.stock.entity.DfcfStockTimeSharding;
...
public class StockTimeSharingHandler implements EventSourceEextension {
    ...
    public void onMessage(String s, MessageEvent messageEvent) throws Exception {
        ...
        System.err.println("解析后的值：\n"+dfcfStockTimeSharding.toString());
        System.err.println("解析后的值长度：\n"+dfcfStockTimeSharding.toString().length());
    }
    ...
    public HttpUrl getUrl() {
        return DongFangCaiFuUtils.getSocketTimeSharingHttpUrl("000980");
    }
}
