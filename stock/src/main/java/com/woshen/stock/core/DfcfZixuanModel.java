...
public class DfcfZixuanModel {
    ...
    private Integer f10;//量比 "f10": 96,
    private String f12;//股票代码 "f12": "002195",
    private Integer f13;//"f13": 0,
    private String f14;//股票名称  "f14": "二三四五",
    private Integer f18;//昨收  "f18": 249,
    private Integer f19;//每股收益  "f19": 6,
    private Integer f22;//涨速  "f22": 0,
    private Integer f30;//现手  "f30": -5434,
